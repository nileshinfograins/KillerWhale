                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="card card-stats bounse">
                                    <div class="card-content clearfix">
                                        <p class="category pull-left">Referral Earning</p>
                                        <p class=" lat-bonse pull-right"><?php echo $user_data->referral_earning; ?> KWT</p>
                                    </div>
                                </div>
                        </div>
                     </div>
...
function send_token_request()
{
    ...
    else
    {
        ...
        var url = '<?php echo base_url(); ?>user/profile/send_token_request';
